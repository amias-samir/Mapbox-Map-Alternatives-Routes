package com.naxa.np.myapplication.utils;
...
import com.naxa.np.myapplication.R;
...
public class DrawRouteOnMap {
    ...
    private DirectionsRoute alternativeRoute1;
    private DirectionsRoute alternativeRoute2;
